...
-- This migration is additive for earlier email-centric lead tables.
...
UPDATE leads
SET idempotency_key = 'legacy:v1:' || id::text
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_leads_idempotency_key_unique
